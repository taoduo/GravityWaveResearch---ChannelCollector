...
%
% NOTE: This function is used for testing, but is NOT used
% to make interferomter noise curves.  Coating specifications
% are in IFOModel, as in 
% >> ifo.Optics.ITM
%                 Transmittance: 0.014
%          CoatingThicknessLown: 0.308
%           CoatingThicknessCap: 0.5
% and specific layer thicknesses are generated in precompIFO,
%   ifo.Optics.XXX.CoatLayerOpticalThickness
%
%
% versions:
