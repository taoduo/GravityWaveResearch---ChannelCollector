function varargout = gwincLF(flo, fhi, ifoin, sourcein, varargin)
...
if (nargin < 4)
  error('usage: gwincLF(flo,fhi,ifo,source,...);');
end
...
case 0
 %y3 = suspR(f, ifo);
 y3 = suspG(f, ifo);                     % loads suspension noise from Giles email May 2015
 y4 = gas(f,ifo);
