...
ifo.Seismic.LowFrequencyLevel = 3 * 1e-9;                   % m/rtHz; seismic noise level below f_knee
...
ifo.Suspension.Type         = 0;               % 0 for cylindrical suspension
...
ifo.Materials.MassRadius = 0.170 * 1^(1/3);            % m; Peter F 8/11/2005
ifo.Materials.MassThickness = 0.200 * 1^(1/3);         % scaled by x^(1/3) for x factor increase in m
