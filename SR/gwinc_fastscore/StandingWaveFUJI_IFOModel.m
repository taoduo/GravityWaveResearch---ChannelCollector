function ifo =StandingWaveFUJI_IFOModel(varargin)
...
%% Infrastructure----------------------------------------------------------
Nfolded=5;
ifo.Infrastructure.NFolded                    = Nfolded;
ifo.Infrastructure.travellingWave             = false;
ifo.Infrastructure.DelayLineSpotSeparation    = 4; % in w
ifo.Infrastructure.Length                     = 3995*(2*Nfolded-1);             % m;
...
ifo.Optics.Loss                     = 37.5e-6*(2*Nfolded-1); % average per mirror power loss
...
%ifo.Materials.MassRadius = 0.465864216110858; %0.170;                     % m; give 300kg mass
ifo.Materials.MassRadius = 0.340219119864505; %0.170;                     % m; give 160 mass
ifo.Materials.MassThickness = 0.200;                  % m; Peter F 8/11/2005
    
ifo.Optics.Curvature.ITM = 1970*(2*Nfolded-1);                      % ROC of ITM
ifo.Optics.Curvature.ETM = 2192*(2*Nfolded-1);                      % ROC of ETM
...
ifo.Optics.ITM.BeamRadius = 0.055*1.5;                     % m; 1/e^2 power radius 
ifo.Optics.ETM.BeamRadius = 0.062*1.5;                     % m; 1/e^2 power radius 
ifo.Optics.ITM.CoatingAbsorption = 0.5e-6;            % absorption of ITM 
ifo.Optics.ITM.Transmittance  = 0.052;                % Transmittance of ITM
ifo.Optics.ETM.Transmittance  = 5e-6;                 % Transmittance of ETM 
ifo.Optics.SRM.Transmittance  = 0.297;                 % Transmittance of SRM
ifo.Optics.PRM.Transmittance  = 0.0515;
