function x0 = gradientOptimizer_FUJI(scoremode,start,variate,stepsize)
...
try, stepsize;
  ...
  stepsize=[1,1e-3,1e-3,1e-3,0,1e-3];
end
maxiter=40;

f_seis = 1; % Seismic Wall Cutoff frequency
f_Nyq = 1e4; % Fake Nyquist frequency
tprmind=5;
shotradmode=2;
ifo=FUJI_IFOModel;
src=SourceModel;
